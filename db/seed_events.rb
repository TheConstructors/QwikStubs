...
Event.create!({:name=>"Alex Against the Machine", :month=>"Apr", :day=>"28", :year=>"2013", :time=>"1:00pm", :venue=>@venue,
...
Event.create!({:name=>"Deadmau5", :month=>"Nov", :day=>"01", :year=>"2013", :time=>"9:00pm", :venue=>@venue, 
    :description=>"Watch Deadmau5 spin those tracks all night long!"})
Event.create!({:name=>"Miley Cyrus", :month=>"Nov", :day=>"03", :year=>"2013", :time=>"9:00pm", :venue=>@venue, 
