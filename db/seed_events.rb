...
Event.create!({:name=>"The Kyle Project", :month=>"Jul", :day=>"12", :year=>"2014", :time=>"1:00pm", :venue=>@venue,
              :description=>"Kyle sings so quietly so make sure to bring your hearing aids folks. Kyle sings so quietly so make sure to bring your hearing aids folks. Kyle sings so quietly so make sure to bring your hearing aids folks. Kyle sings so quietly so make sure to bring your hearing aids folks. Kyle sings so quietly so make sure to bring your hearing aids folks. Kyle sings so quietly so make sure to bring your hearing aids folks.Kyle sings so quietly so make sure to bring your hearing aids folks."})
