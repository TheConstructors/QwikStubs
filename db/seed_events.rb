...
Event.create!({:name=>"Miley Cyrus", :month=>"Nov", :day=>"3", :year=>"2013", :time=>"9:00pm", :venue=>@venue, 
    :description=>"Because she can't be tamed ya'll better by some tickets for her Hannah Montana Tour, ya hear?", :date=>Date.new(2013, 11, 3)})
Event.create!({:name=>"Imagine Dragons", :month=>"Nov", :day=>"11", :year=>"2013", :time=>"9:00pm", :venue=>@venue, 
    :description=>"Imagine Dragons travels to 25 cities on their Radioactive 2013 Tour.", :date=>Date.new(2013, 11, 11)})
